...
public class StreamEx8 {
    public static void main(String[] args) {
        Student[] stuArr = {
                ...
                new Student("김지미", false, 1, 1, 200),
                new Student("김자바", true, 1, 2, 100),
                new Student("이지미", false, 1, 2, 150),
                new Student("남자바", true, 1, 1, 200),
                new Student("안지미", false, 1, 3, 290),
                new Student("황지미", false, 1, 3, 290),
                new Student("강지미", false, 1, 3, 180),
                new Student("이자바", true, 2, 3, 300),

                new Student("나자바", true, 2, 3, 300),
                new Student("김지미", false, 2, 1, 200),
                new Student("김자바", true, 2, 2, 100),
                new Student("이지미", false, 2, 2, 150),
                new Student("남자바", true, 2, 1, 200),
                new Student("안지미", false, 1, 3, 290),
                new Student("황지미", false, 2, 3, 290),
                new Student("강지미", false, 2, 3, 180),
                new Student("이자바", true, 2, 3, 300),
        };
        ...
        System.out.printf("%n3. 단순그룹화 + 통계(성젹별 학생수)%n");
        ...
        /*
        * for(List<Student> level : stuByLever.values()){
        *   System.out.println();
        *   for(Student s : level){
        *       System.out.println(s);
        *   }
